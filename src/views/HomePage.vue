  ...
  <div class="home">
    ...
    <main>
      <div class="text-section">
        ...
        <button class="btn participate-btn" href="/participer">Participer</button>
      </div>
...
.logo {
  width: 20%; /* Adjust height if needed */
}
